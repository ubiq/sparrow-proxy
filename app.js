...
var handleMethod = function(res, method, params) {
  switch (method) {
    case 'eth_blockNumber':
      ...
      break;
    case 'eth_getBalance':
      return {address: formatAddress(params[0]), result: Response.getBalance(params[0])};
      break;
    case 'eth_call':
    ...
    case 'eth_getTransactionCount':
      return {result: Response.getTransactionCount({data: params[0], quantity: params[1]})};
      break;
    ...
    case 'eth_gasPrice':
      ...
      break;
    case 'eth_getCode':
      return {result: Response.getCode({data: params[0], quantity: params[1]})};
      break;  
    case 'net_version':
      return {result: Response.netVersion()};
      break;  
    default:
      return {
        error: true,
